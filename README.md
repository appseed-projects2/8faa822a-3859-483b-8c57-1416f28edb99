...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-09-11 08:58`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8faa822a-3859-483b-8c57-1416f28edb99.git
$ cd 8faa822a-3859-483b-8c57-1416f28edb99
```
